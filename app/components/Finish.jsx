...
export default class FinishScreen extends React.Component {
  ...
  _getFinishScreenTitle(progress_measure, score){
    ...
    if(hasProgressMeasure && hasScore){
      finishTitleText = this.props.I18n.getTrans("i.finish_screen_title_full", {progress_measure:(progress_measure), score:(score)});
    } else if(hasProgressMeasure){
      finishTitleText = this.props.I18n.getTrans("i.finish_screen_title_wpm", {progress_measure:(progress_measure)});
    } else if(hasScore){
