        ...
        <div className="quiz">
          ...
          <div className="quizButtonsWrapper">
            <p>
              ...
              <button className="answerTrue" onClick={this.onAnswerTrue.bind(this)} disabled={this.state.answered}>{I18n.getTrans("i.true")}</button>
              <button className="answerFalse" onClick={this.onAnswerFalse.bind(this)} disabled={this.state.answered}>{I18n.getTrans("i.false")}</button>
            </p>
            <p>
